...
res_title = ['C96', "D48 P96", "C48", "D48 P24"]

#------------------------------------------------------------------------------#
# Create axes                                                                  #
#------------------------------------------------------------------------------#

fig, ax = plt.subplots(4, 2, figsize=(20,20), sharex='col', sharey='row')
...
for i in range(4):
    ...
    if (i==3):
        add_colorbar_ax(ax[i,0], cf, field_labels[0], location='bottom')
...
add_colorbar_ax(ax[3,1], cf, field_labels[1], location='bottom')
